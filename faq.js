Vue.component('faq', {
    ...
    <div>
        <div class = "content_faq">
            ...
            <div class = "faq_box">
                <details>
                    <summary>How do you recommend users about social issues?</summary>
            ...
            <div class = "faq_box">
                <details>
                    <summary><h4>How do you determine what constitutes an important social issue?</h4></summary>
            ...
            <div class = "faq_box">
                <details>
                    <summary><h4>How will you make sure all the cards are introducing social issues, rather than fake news or propaganda?</h4></summary>
            ...
            <div class = "faq_box">
                <details>
                    <summary><h4>How do you use Involvepedia?</h4></summary>
            ...
            <div class = "faq_box">
                <details>
                    <summary><h4>Why should I use Involvepedia?</h4></summary>
            ...
            <div class = "faq_box">
                <details>
                    <summary><h4>How do you add new cards?</h4></summary>
